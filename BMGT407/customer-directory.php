...
$query = "SELECT * FROM CustomerDatabase";
						...
						<!-- NOTE: I ENDED PHP HERE to make it easier to display my <form> for the details button -->
							<td>
								<form action="student_detail.php" method="GET">
									<button type="submit" name="UID" value="<?php echo $record['UID'];?>">Details</button>
								</form>
							</td>
							<!-- Literally the same code, except this goes to the edit page -->
							<td>
								<form action="edit_student.php" method="GET">
									<button type="submit" name="editUID" value="<?php echo $record['UID'];?>">Edit</button>
								</form>
							</td>
